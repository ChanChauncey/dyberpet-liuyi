...
TAG = "v1.0.2"
BODY = (
    "LiuYi Desktop Pet v1.0.2\n\n"
    "- Check-update notification moved to top of window\n"
    "- Installer now detects a running instance and can auto-close it before installing\n"
    "- Check-update proxy detection enhanced (reads system/IE proxy automatically)\n"
    "- Fixed first-launch config migration crash\n"
    "- About panel shows current version\n\n"
