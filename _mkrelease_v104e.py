...
BODY = (
    ...
    "- Differential update: future auto-updates download only the small source patch\n"
    "  (DyberPet_source.zip, a few MB) instead of the full 245MB installer\n"
    "- Check-update result shown at top of window; current version shown in About\n\n"
    "Download LiuYi_Setup.exe to install. Existing users get the small patch automatically."
)
...
# 4) 上传完整安装包（约 245MB，可能耗时）
print("=== uploading LiuYi_Setup.exe ===", file=sys.stderr)
